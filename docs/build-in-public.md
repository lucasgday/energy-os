...
- Real well lists or asset maps unless explicitly approved for public release.
...
Be specific, technical, and honest. Avoid hype around autonomous operations. The project should earn credibility by showing working systems, realistic constraints, and clear evidence.

## Contributor Rule

Contributors should use synthetic or approved public data only. If a contribution depends on private data, convert it into a synthetic example before opening a public issue or pull request.
